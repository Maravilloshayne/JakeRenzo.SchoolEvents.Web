...
using JakeRenzo.Calander.Web.ViewModels.Account;
    ...
    public class AccountController : Controller
    {
        ...
        public IActionResult Register(RegisterViewModel model)
        {
            ...
            if (duplicate == null)
            {
                ...
                User user = new User()
                {
                    ...
                    Gender = model.Gender,
                    LoginStatus = Infrastructures.Enums.LoginStatus.NewRegister,
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            ...
            if (user != null)
            {
                ...
                {
                    if (user.LoginStatus == Infrastructures.Enums.LoginStatus.Locked)
                    {
                        ModelState.AddModelError("", "Your account has been locked please contact an Administrator.");
                        return View();
                    }
                    else if (user.LoginStatus == Infrastructures.Enums.LoginStatus.NewRegister)
                    {
                        ModelState.AddModelError("", "Please verify your account first.");
                        return View();
                    }
                    else if (user.LoginStatus == Infrastructures.Enums.LoginStatus.NeedsToChangePassword)
                    {
                        user.LoginTrials = 0;
                        user.LoginStatus = Infrastructures.Enums.LoginStatus.Active;
                        this._context.Users.Update(user);
                    ...
                    else if (user.LoginStatus == Infrastructures.Enums.LoginStatus.Active)
                    {
                        user.LoginTrials = 0;
                        user.LoginStatus = Infrastructures.Enums.LoginStatus.Active;
                        this._context.Users.Update(user);
                ...
                else
                {
                    ...
                    {
                        ModelState.AddModelError("", "Your account has been locked please contact an Administrator.");
                        user.LoginStatus = Infrastructures.Enums.LoginStatus.Locked;
                    }
                    this._context.Users.Update(user);
                    this._context.SaveChanges();
        ...
        public IActionResult ForgotPassword(ForgotPasswordViewModel model)
        {
            ...
            if (user != null)
            {
                ...
                user.LoginStatus = Infrastructures.Enums.LoginStatus.NeedsToChangePassword;
                this._context.Users.Update(user);
                this._context.SaveChanges();
                this.SendNow(
