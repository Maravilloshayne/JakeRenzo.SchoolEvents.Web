...
using JakeRenzo.Calander.Web.Areas.Manage.ViewModels.Users;
...
namespace JakeRenzo.Calander.Web.Areas.Manage.Controllers
{
    [Area("Manage")]
    public class UserAccountController : Controller
    {
        private readonly DefaultDbContext _context;
        public UserAccountController(DefaultDbContext context)
        {
