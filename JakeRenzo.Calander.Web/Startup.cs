...
namespace JakeRenzo.Calander.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           .AddCookie(options =>
           {
               ...
               options.Cookie.Name = "JakeRenzo.Calander.Web";
           });
            ...
            services.AddDbContext<DefaultDbContext>(options => options.UseMySql(Configuration.GetConnectionString("DefaultDbContextMySQL"), m => m.MigrationsAssembly("JakeRenzo.Calander.Web")));
